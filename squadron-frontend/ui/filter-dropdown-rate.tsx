...
const StyledInput = styled.input<{
  ...
  `;
interface RateDropdownFilterProps {
    showDivider?: boolean;
    inputHeight?: string;
    inputWidth?: string;
...
const RateDropdownFilter: React.FC<RateDropdownFilterProps> = ({
    showDivider = true,
}) => {
...
export default RateDropdownFilter;
