   ...
   <Table >
     <TableHead>
       <TableRow>     
         ...
         <svg width="16" height="16" viewBox="-3 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.99967 3.33398V12.6673M7.99967 12.6673L12.6663 8.00065M7.99967 12.6673L3.33301 8.00065" stroke="#4D5761" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
         </TableCell>
     ...
     <TableBody>
       {rows2.map((row) => (
         ...
         >
           ...
           <TableCell  >
             <Chip size="small" icon={<PermIdentityOutlinedIcon  style={{color: '#026AA2'}} />}label={row.Invitedtorole} style={{ backgroundColor: '#A0E7F8', color: '#026AA2' }}
              />
