...
const Buttonh3 =styled.button`
margin-left: 10px;
margin-top: 10px;
border-radius: 8px;
border: 1px solid var(--primary-600, #4B48EC);
background: var(--primary-600, #4B48EC);
box-shadow: 0px 1px 2px 0px rgba(16, 24, 40, 0.05);
padding: 10px 16px;


color: var(--base-white, #FFF);
font-family: 'Inter', sans-serif; /* Ensure that the 'Inter' font is imported or available on your site */
font-size: 14px;
font-style: normal;
font-weight: 600;
...
{/* <Buttonh3>
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="2 -4 20 20" fill="none">
  <path d="M10 4.1665V15.8332M4.16669 9.99984H15.8334" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
Create project  
</Buttonh3> */}
