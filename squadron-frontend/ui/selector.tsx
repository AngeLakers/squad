//from https://github.com/driaug/country-picker
              ...
              <div className="sticky top-0 z-10 bg-white">
                <li className=" text-gray-900 cursor-default select-none relative py-2 px-3">
                  <input
                    ...
                    name="search"
                    autoComplete={"off"}
                    className="focus:ring-blue-500 focus:border-none focus:outline-none block w-full sm:text-sm border-gray-300 rounded-md"
